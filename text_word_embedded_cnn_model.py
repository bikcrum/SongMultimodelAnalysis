# -*- coding: utf-8 -*-
"""text_word_embedded_CNN_model.ipynb
...
preprocessed_df['cluster'] = create_cluster(preprocessed_df, num_clusters=4) #num classes need to be defined earlier
...
embedding_matrix = make_embeddings_matrix(embeddings=glove_embeddings, word_index=inputs.word2idx, embedding_dim=EMBEDDING_DIM) #tokenizer.token_to_index
